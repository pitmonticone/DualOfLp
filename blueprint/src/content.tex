...
\begin{proof}
\leanok
Let $E$ be a discrete, real, topological vector space: for every $v\in E$, y continuity of the multiplication, the line $\RR\smul v$ is both connected and discrete, so it is a singleton. This shows $v=0$.
\end{proof}
