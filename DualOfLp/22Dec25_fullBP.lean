...
This project request had uuid: 74bb06d4-2fdb-4d20-b725-bd81106dbe7e
-/

/-
We proved that for $0 < p < 1$, the space $L^p([0,1])$ is not Bolognese. This was done by showing
that the dual space of $L^p([0,1])$ is trivial (zero), while Bolognese spaces must have a
separating dual. To prove the dual is zero, we showed that any continuous linear functional must
vanish, using the fact that any function in $L^p$ can be decomposed into a sum of functions with
rbitrarily small norms (due to the non-convexity of the unit ball for $p < 1$). We also defined the
restriction of $L^p$ functions and proved properties about splitting functions into parts with
specific norm ratios.
-/
...
Lean version: leanprover/lean4:v4.24.0
Mathlib version: f897ebcf72cd16f89ab4577d0c826cd14afaafc7
This project request had uuid: b4a599b8-bce4-4096-87c3-70ef8924f35d
...
Lean version: leanprover/lean4:v4.24.0
Mathlib version: f897ebcf72cd16f89ab4577d0c826cd14afaafc7
This project request had uuid: 26a7e3c4-f6d2-4c73-b9eb-87aeed7ae3a3
